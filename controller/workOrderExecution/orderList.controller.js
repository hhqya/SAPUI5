sap.ui.define([
    ...
    "use strict";
    return BaseController.extend("sap.ui.message.controller.workOrderExecution.orderList", {
        onInit: function () {
        ...
        deleteButton:function(row){
            MessageBox.confirm("确定删除当前行数据?");
            row = this._oTable;
            this._oTable = this.getView("employeesTable");
            console.log(row);
        },
        updateButton:function(oEvent){
            this.getRouter().navTo("editList");
        },
        infoButton:function(oEvent){
        ...
        _initViewSettingsDialog : function () {
            ...
            this._oVSD = new sap.m.ViewSettingsDialog("vsd", {
                confirm: function (oEvent) {
                    ...
                    this.oRouterArgs.query.showDialog;
                    oRouter.navTo("employeeOverview", this._oRouterArgs, true);
                }.bind(this),
                cancel: function(oEvent){
                    this._oRouterArgs.query.showDialog;
                    oRouter.navTo("employeeOverview", this._oRouterArgs, true);
                }.bind(this)
            });
